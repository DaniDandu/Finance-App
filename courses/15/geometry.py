...
# protected -> only from the class and its children (and nephews and son on), declare with "_"
# private -> only form the class, declare with "__" in front
...
class GeometricalForm(abc.ABC):
    ...
    @abstractmethod # called decorator, abstract method imposes implementations on children
    def area(self) -> float:
        pass
