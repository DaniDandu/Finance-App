...
class Achizitie:
    ...
    def return_proposed_vehicles(self) -> list[Automobil]:
        ...
        return [
            m for m in self.masini if nr_cilindri == m.get_motor().get_nr_cilindri() and
...
masina1 = Automobil(Motor(4, 5, 6, "benzina", "ser", "c", "combustibil"), "albastru", "tesla", True, True,
                    "discuri", True, False, 4, 4, 6, 30, 0, 3, 2, 1, 10, 5, 8)
masina2 = Automobil(Motor(4, 5, 6, "benzina", "ser", "c", "combustibil"), "rosie", "tesla", True, True,
                    "discuri", True, False, 4, 4, 6, 30, 0, 3, 2, 1, 10, 5, 8)
masina3 = Automobil(Motor(4, 5, 6, "benzina", "ser", "c", "combustibil"), "neagra", "tesla", True, True,
                    "discuri", True, False, 4, 4, 6, 30, 0, 3, 2, 1, 10, 5, 8)
masina4 = Automobil(Motor(4, 5, 6, "benzina", "ser", "c", "combustibil"), "alba", "tesla", True, True,
                    "discuri", True, False, 4, 4, 6, 30, 0, 3, 2, 1, 10, 5, 8)
masina5 = Automobil(Motor(4, 5, 6, "benzina", "ser", "c", "combustibil"), "albastru", "tesla", True, True,
                    "discuri", True, False, 4, 4, 5, 30, 0, 3, 2, 1, 10, 5, 8)
masina6 = Automobil(Motor(4, 5, 6, "benzina", "ser", "c", "combustibil"), "albastru", "tesla", True, True,
                    "discuri", True, False, 4, 4, 6, 32, 0, 3, 2, 1, 10, 5, 8)
masina7 = Automobil(Motor(4, 5, 6, "benzina", "ser", "c", "combustibil"), "albastru", "tesla", True, True,
