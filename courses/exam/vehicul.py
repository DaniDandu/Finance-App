...
class Vehicul:
    def __init__(self, nr_roti: int, nr_usi: int, nr_locuri: int, capacitate_rezervor: int, capacitate_portbagaj: int,
                 lungime: int, latime: int, inaltime: int, consum_urban: int, consum_extraurban: int, consum_mixt: int):
