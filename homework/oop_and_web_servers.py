...
class Game(EntertainmentItem):
    def __init__(self, name: str, studio: str, total_hours: int, hours_palyed: int):
        super().__init__(name, studio, total_hours, hours_palyed)
...
class OurHandler(BaseHTTPRequestHandler):
    ...
    def write_to_body(self, items, method_to_json: str = "to_json"):
